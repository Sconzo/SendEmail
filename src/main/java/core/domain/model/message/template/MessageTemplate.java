package core.domain.model.message.template;

import core.domain.model.UpdatableBaseAudit;
import core.domain.model.account.Account;
import core.domain.model.message.Message;
import core.domain.model.message.template.enums.ActionEnum;
import core.domain.model.message.template.enums.RecipientTypeEnum;
